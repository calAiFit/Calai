...
function FoodNutritionAnalyzer({ onIntakeAdded }) {
    ...
    async function classifyImage(imageBase64) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`https://api-inference.huggingface.co/models/${model}`, {
                inputs: imageBase64
            }, {
                headers: {
...
_s(FoodNutritionAnalyzer, "FPkbgEVc2GmE9MZAwwyziIgSaMs=");
...
//# sourceMappingURL=_94d83768._.js.map